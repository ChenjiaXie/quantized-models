...
def inception_v3(opts,pretrained=False, progress=True, quantize=False, **kwargs):
    ...
    model = QuantizableInception3(opts,**kwargs)
    _replace_relu(model)
...
class QuantizableBasicConv2d(inception_module.BasicConv2d):
    def __init__(self,opts, *args, **kwargs):
        super(QuantizableBasicConv2d, self).__init__(opts,*args, **kwargs)
        self.relu = nn.ReLU()
        self.comp=ComP(opts)
...
class QuantizableInceptionA(inception_module.InceptionA):
    def __init__(self, opts, *args, **kwargs):
        super(QuantizableInceptionA, self).__init__(opts,conv_block=QuantizableBasicConv2d, *args, **kwargs)
...
class QuantizableInceptionB(inception_module.InceptionB):
    def __init__(self, opts, *args, **kwargs):
        super(QuantizableInceptionB, self).__init__(opts, conv_block=QuantizableBasicConv2d, *args, **kwargs)
        self.myop = nn.quantized.FloatFunctional()
...
class QuantizableInceptionC(inception_module.InceptionC):
    def __init__(self, opts,*args, **kwargs):
        super(QuantizableInceptionC, self).__init__(opts,conv_block=QuantizableBasicConv2d, *args, **kwargs)
        self.myop = nn.quantized.FloatFunctional()
...
class QuantizableInceptionD(inception_module.InceptionD):
    def __init__(self, opts,*args, **kwargs):
        super(QuantizableInceptionD, self).__init__(opts,conv_block=QuantizableBasicConv2d, *args, **kwargs)
        self.myop = nn.quantized.FloatFunctional()
...
class QuantizableInceptionE(inception_module.InceptionE):
    def __init__(self,opts, *args, **kwargs):
        super(QuantizableInceptionE, self).__init__(opts,conv_block=QuantizableBasicConv2d, *args, **kwargs)
...
class QuantizableInceptionAux(inception_module.InceptionAux):
    def __init__(self, opts, *args, **kwargs):
        super(QuantizableInceptionAux, self).__init__(opts,conv_block=QuantizableBasicConv2d, *args, **kwargs)


class QuantizableInception3(inception_module.Inception3):
    def __init__(self, opts, num_classes=1000, aux_logits=True, transform_input=False):
    ...
    def loadPreTrained(self):
        self.load_state_dict(torch.load('qmodels/inception_v3_google_fbgemm-71447a44.pth'))
