...
class QuantizableInvertedResidual(InvertedResidual):
    def __init__(self, opts, *args, **kwargs):
        super().__init__(opts, *args, se_layer=QuantizableSqueezeExcitation, **kwargs)
...
def _mobilenet_v3_model(
    ...
    **kwargs: Any
    ...
    model = QuantizableMobileNetV3(opts, inverted_residual_setting, last_channel, block=QuantizableInvertedResidual, **kwargs)
    _replace_relu(model)
...
def mobilenet_v3_large(opts,pretrained=False, progress=True, quantize=False, **kwargs):
    """
    ...
    return _mobilenet_v3_model(opts,arch, inverted_residual_setting, last_channel, pretrained, progress, quantize, **kwargs)
