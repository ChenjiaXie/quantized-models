...
def googlenet(args, pretrained=False, progress=True, quantize=False, **kwargs):
    ...
    model = QuantizableGoogLeNet(args, **kwargs)
    _replace_relu(model)
...
class QuantizableGoogLeNet(GoogLeNet):
    ...
    def loadPreTrained(self):
        self.load_state_dict(torch.load('qmodels/googlenet_fbgemm-c00238cf.pth'))
